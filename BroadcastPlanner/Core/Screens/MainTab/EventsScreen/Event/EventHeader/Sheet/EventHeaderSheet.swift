...
//                    }
//                    Task{
//                        await  mdm.localDataManager.saveContext(type: .main, publish: .none, id: [])
//                    }
//                }
...
//                    
//                    mdm.updateClubWithClub(club: club, title: title, uiimage: uiimage, contacts: contacts, urlString: urlString, location: location, inContext: .main)
//                    withAnimation{
...
//    NavigationStack{
//        BPCreateEditEventView(event: LocalEvent(context: mdm.localDataManager.moc), userId: "123")
//    }
