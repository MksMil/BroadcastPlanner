...
//                            ForEach(viewModel.event.eventPlan.fieldPoints) { point in
//                                Text("\(point.eventPlanPointNumber)")
//                                    .fixedSize()
//                                    .padding(10)
//                                    .frame(width: 115, height: 50)
//                                    .background(viewModel.selectedEventPoint?.id == point.id ?  .ultraThickMaterial : .ultraThinMaterial
//                                    )
//                                    .onTapGesture {
//                                        withAnimation {
...
#Preview {
    BPEditEventPlanView(event: MockData.sampleEvent)
