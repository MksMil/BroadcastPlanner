    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            TabViewList(
                ...
                vm.publisher.send((PointInfoPublishType.number, num))
            } content: { num in
                SelectablePointEditCellWithContent(
                    val: num,
                    publishType: PointInfoPublishType.number
                ) {
            ...
            TabViewList(
                ...
                vm.publisher.send(
                    (PointInfoPublishType.optic, optic)
                )
            } content: { optic in
                SelectablePointEditCellWithContent(
                    val: optic,
                    publishType: PointInfoPublishType.optic
                ) {
            ...
            TabViewList(
                ...
                vm.publisher.send(
                    (PointInfoPublishType.placeType, place)
                )
            } content: { place in
                SelectablePointEditCellWithContent(
                    val: place,
                    publishType: PointInfoPublishType.placeType
                ) {
            ...
            TabViewList(
                ...
                vm.publisher.send(
                    (PointInfoPublishType.windDefence, defence)
                )
            } content: { defence in
                SelectablePointEditCellWithContent(
                    val: defence,
                    publishType: PointInfoPublishType.windDefence
                ) {
            ...
            TabViewList(
                ...
                vm.publisher.send(
                    (PointInfoPublishType.light, light)
                )
            } content: { light in
                SelectablePointEditCellWithContent(
                    val: light,
                    publishType: PointInfoPublishType.light
                ) {
...
//            Divider()
            ...
            TabViewList(
                ...
                vm.publisher.send((PointInfoPublishType.user, user))
            } content: { user in
                SelectablePointEditCellWithContent(
                    val: user,
                    publishType: PointInfoPublishType.user
                ) {
