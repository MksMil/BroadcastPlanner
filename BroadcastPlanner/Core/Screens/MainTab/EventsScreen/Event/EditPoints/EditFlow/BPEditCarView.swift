...
//    @EnvironmentObject var globalStorage: GlobalStorage
    ...
    @State private var selectedUnit: OBVanUnit?
    
    //if user cant edit(he is not owner)
    var editable: Bool
    
    @State private var isEdit: Bool = true
    @State private var selectedUnits: [OBVanUnit] = []
                    ...
                    .overlay {
                        HStack(spacing: 0){
                            ...
                            if editable{
                                ...
                                Menu {
                                    ScrollView{
//                                        ForEach(settings.broadcasterTemplates) { bc in
//                                            Button("\(bc.id)") {
                    ...
                    HStack {
                        Menu {
                            ScrollView{
                                ...
                                if editManager.selectedBroadcaster != nil{
                                    Button("+ new car") {
                                        print("add new car")
                                    }
                                    .disabled(true)
...
//        }
    ...
    func showSelectedUnits() -> [OBVanUnit]{
