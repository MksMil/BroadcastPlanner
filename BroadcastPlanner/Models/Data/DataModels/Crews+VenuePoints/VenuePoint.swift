...
extension VenuePoint: CoreDataUpdatable{
    ...
    func updateValues(number: Int?,x:Double?,y:Double?,rotation: Double?,scaleFactor: Double?,pointDescription: String?,task: String?,image: LocalImage?,imageString: String?,cameras: [Camera]?,broadcast: Broadcast?,sounds: [Sound]?,lights: [Light]?,members: [Member]?,in context: NSManagedObjectContext){
        if let number {
