...
extension Crew: CoreDataUpdatable{
    ...
    func updateWithBroadcast(_ broadcast: Broadcast, dto: CrewDTO, in context: NSManagedObjectContext){
        self.broadcast = broadcast
        updateFromDTO(dto, in: context)
    }
    ...
    func updateValues(position: String?, x: Double?, y: Double?, scaleFactor: Double?, rotation: Double?,task: String?,member: Member?,hardware:Hardware?, broadcast: Broadcast?,obvan: Obvan?,in context: NSManagedObjectContext){
        if let position {
